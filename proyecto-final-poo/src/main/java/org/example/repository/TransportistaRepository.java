...
import org.example.model.CarrierType;
...
public class TransportistaRepository implements CRUD<Carrier>{
    ...
    private List<CarrierType> carrierTypes;
    ...
    @Override
    public void upLoad() {
        CarrierType terrestre = new CarrierType("Terrestre");
        CarrierType aereo = new CarrierType("Aereo");
        CarrierType maritimo = new CarrierType("Maritimo");
