 ...
 * @author ericp
 */
public class PanelSeeOrderLines extends javax.swing.JPanel {
    private ViewController viewController;
    private OrderController orderController;
    

    /**
     * Creates new form PanelSeeOrderLines
     */
    public PanelSeeOrderLines() {
    ...
    private void initComponents() {
        ...
        lblWelcome.setText("VER LINEAS DE PEDIDO");
    ...
    private void bttnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnConfirmActionPerformed
        if (tblOrders.getRowCount() > 0) {
            if (tblOrders.getSelectedRow() != -1) {
                ...
                tblOrderLines.setModel(viewController.modelTableOrderLinesByOrder(orderNumber));
            }
        }
