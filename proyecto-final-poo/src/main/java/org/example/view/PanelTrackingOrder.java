 ...
 * @author ericp
 */
public class PanelTrackingOrder extends javax.swing.JPanel {
private ViewController viewController;
private CalcDistance calcDistance;
private OrderController orderController;
    /**
     * Creates new form PanelTrackingOrder
     */
    public PanelTrackingOrder() {
    ...
    private void initComponents() {
        ...
        lblWelcome.setText("SEGUIMIENTO DE PEDIDO");
        ...
        bttnConfirm.setText("Seleccionar");
        ...
        lblInfo1.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(lblStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 582, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblWelcome))
                        .addGap(105, 105, 105))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(txtOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(bttnOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(128, 128, 128))))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(100, 100, 100)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(lblOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(lblInfo1, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(255, 255, 255)))
        );
    ...
    private void bttnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnConfirmActionPerformed
        if (tblOrders.getRowCount() > 0) {
            if (tblOrders.getSelectedRow() != -1) {
                ...
                Order order = this.orderController.findOneByOrderNumber(orderNumber);
                calcDistance = new CalcDistance();
                if(order.getTracking()!=null){
                Double distance = calcDistance.calcDistance(order.getTracking().getLatitude(), order.getTracking().getLongitude(), order.getWarehouseDest().getPosition().getLatitude(), order.getWarehouseDest().getPosition().getLongitude());
                Double roundedDistance = Math.round(distance * 100.0) / 100.0;
                lblInfo1.setText("Su pedido se encuentra a " + roundedDistance + " kilometros del déposito destino");
                lblStatus.setText("Y su estado es: " +order.getOrderStatus());
                } else {
                    lblStatus.setText("Su pedido todavia no está despachado.");

                }
            } else {
                            JOptionPane.showMessageDialog(this, "Por favor seleccione el pedido!", "Error", JOptionPane.ERROR_MESSAGE);
